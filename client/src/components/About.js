...
const About = () => (
    <div className="pt-4">
        ...
        <Parallax bgImage={"%PUBLIC_URL%/station.jpg" || station} strength={500}>
        ...
        <Parallax bgImage={rasPI} blur={{ min: -5, max: 5 }} strength={-500}>
            <div style={{ height: 500 }}>
                <div style={insideStyles}>
                    <h3>Method</h3>
                    <p>
        ...
        <Parallax bgImage={stationBW} strength={500}>
            <div style={{ height: 500 }}>
                <div style={insideStyles}>
